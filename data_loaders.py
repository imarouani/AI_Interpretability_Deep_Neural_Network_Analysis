...
def load_cifar10(data_dir, batch_size=32, shuffle_buffer_size=10000, seed=42):
    ...
    train_ds, val_ds, test_ds = tfds.load('cifar10', data_dir=data_dir, split=['train', 'test[:50%]', 'test[50%:]'])
...
def load_wine_quality(data_dir, batch_size=32, shuffle_buffer_size=10000, seed=42):
    ...
    dataset = tfds.load('wine_quality/white', data_dir=data_dir, split='train')
